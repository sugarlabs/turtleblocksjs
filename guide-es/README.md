...
GitHub](http://rawgit.com/sugarlabs/turtleblocksjs/master/index.html),
o mediante la creación de [un servidor
local](https://github.com/sugarlabs/turtleblocksjs/blob/master/server.md).
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/basics1.svg' />

Una sola línea de longitud 100

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/basics2.svg' />

Cambio de la longitud de la línea a 200

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/basics3.svg' />

Adición de un giro a la derecha de 90 grados. La ejecución de esta
pila cuatro veces produce un cuadrado.

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/basics4.svg' />

Adelante, derecha, adelante, derecha, ...

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/basics5.svg' />

Utilizando el bloque de repetición de la paleta de flujo

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/basics6.svg' />

Usando el bloque de Arco para hacer esquinas redondeadas

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/basics7.svg' />

Utilizando comenzar relleno y terminan Relleno de la paleta de la
pluma para hacer un cuadrado sólido

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/basics8.svg' />

Cambiar el color a 70 (azul) con el bloque Set color de la paleta de
la pluma

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/basics9.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/boxes1.svg' />

Poner un valor en una caja y luego hacer referencia al valor en la caja

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/boxes2.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/boxes3.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/actions1.svg' />

Definición de una acción para crear un nuevo bloque, "cuadrado"

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/actions2.svg' />

Uso del bloque "cuadrado"

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/actions3.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/parameters1.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/parameters2.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/parameters3.svg' />

A menudo sólo quiere incrementar un parámetro en 1. Para ello, utilice
Añardir-1-a bloque.

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/parameters4.svg' />

Para incrementar (o disminuir) un parámetro por un valor arbitrario,
utilice Añardir-1-a bloque.

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/parameters5.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/conditionals1.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/conditionals2.svg' />

Las condicionales junto con el bloque aleatorio pueden ser utilizadas
para simular un lanzamiento de moneda.

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/conditionals3.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/media1.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/media2.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/media3.svg' />

Mostrar bloque en combinación con el bloque de la cámara capturará y
mostrara una imagen de una cámara web.

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/media4.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/sensors1.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/paint1.svg' />

En su forma más simple, la pintura es sólo cuestión de mover la
tortuga para donde el ratón se posicione.

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/paint2.svg' />

Añadir una prueba para el botón del ratón nos permite mover a la
tortuga sin dejar un rastro de tinta.

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/paint3.svg' />

En este ejemplo, cambiamos el tamaño de la pluma sobre la base del
volumen de entrada de micrófono.

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/paint4.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/slideshow1.svg' />
...
--------------------------
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/keyboard.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/keyboard2.svg' />

8. Tortugas, Sprites, botones, y eventos
----------------------------------------

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/turtles1.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/turtles2.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/turtles3.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/turtles4.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/actions4.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/actions6.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/fibonacci1.svg' />

Cálculo de Fibonacci [CORRER  EN VIVO](http://turtle.sugarlabs.org/?file=Fibonacci-1.tb&run=true)

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/fibonacci2.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/turtles5.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/boxes4.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/boxes5.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/boxes6.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/heap1.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/heap2.svg' />

En el segundo ejemplo, sacamos el estado pluma, X, y Y fuera de la
pila y reproducimos nuestro dibujo.

<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/heap3.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/heap4.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/extras1.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/debugging1.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/debugging2.svg' />
...
<img src='https://rawgithub.com/sugarlabs/turtleblocksjs/master/guide-es/color1.svg' />
