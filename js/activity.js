	...
	var evalArgDict = {};
        ...
        function errorMsg(msg, blk) {
            ...
            if (blk !== undefined || blk !== null) {
                ...
                errorMsgArrow = new createjs.Shape();
                stage.addChild(errorMsgArrow);
                errorMsgArrow.graphics.setStrokeStyle(2)
                              .beginStroke('#ff0031')
                              .moveTo(fromX, fromY)
                              .lineTo(toX, toY);
                stage.swapChildren(errorMsgArrow, last(stage.children));
                //stage.update();
                //arrowPoint(Math.atan2((300 - tox), (10 - toy)), tox, toy);
            }
        ...
        function runLogoCommands(startHere) {
            ...
            if (errorMsgArrow !== null) {
                errorMsgArrow.visible = false; // hide the error arrow
            }
