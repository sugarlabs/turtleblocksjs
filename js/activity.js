...
// sugarizerCompability.ifInsideSugarizerHideLoading();
...
define(function(require) {
  ...
  require(['domReady!'], function(doc) {
    ...
    function saveLocally() {
      if (sugarizerCompability.isInsideSugarizer()) {
        sugarizerCompability.saveLocally(prepareExport());
        return;
      }
    ...
    function loadStart() {
      ...
      if (sugarizerCompability.isInsideSugarizer()) {
        sugarizerCompability.loadStart(blocks, justLoadStart);
        update = true
        return;
      }
    ...
    function setupAndroidToolbar(showPalettesPopover) {
      ...
      if (sugarizerCompability.isInsideSugarizer()) {
        buttonNames.push(['sugarizer-stop', function() {
          sugarizerCompability.saveLocally(prepareExport(), function() {
            sugarizerCompability.sugarizerStop();
          })
        }])
      }
