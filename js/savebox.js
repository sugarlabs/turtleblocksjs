...
function SaveBox(canvas, stage, refreshCanvas, save) {
    ...
    this.show = function(scale) {
		...
		box.completeShow();
            ...
            makeBoxBitmap(this, SAVEBOX, 'box', processBackground, null);
        } else {
            this.completeShow();
        }
    }
